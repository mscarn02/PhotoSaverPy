...
destination_folder = '*PATH TO FODER*'
...
#print(dfAlbums)
#Diwali_id = dfAlbums[dfAlbums['title'] == 'Diwali']['id'].to_string(index=False).strip()
C_id = dfAlbums[dfAlbums['title'] == 'tiger']['id'].to_string(index=False).strip()
print(C_id,'\n')
